...
lm_eqn
g<-g+geom_text(data=lm_eqn,aes(x = 25, y = 300,label=V1), parse = TRUE, inherit.aes=FALSE) + facet_grid(group~.)
g
#I haven't yet figured out how to label the equation
```
...
#Notes: I could not figure out how to make a legend. So far I have the following:
